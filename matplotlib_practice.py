...
x = dfs_mm_mx[26057][dfs_mm_mx[26057].index.month == 12].index.year
y = dfs_mm_mx[26057][dfs_mm_mx[26057].index.month == 12]['tmax']
...
for i in range(1,13):
       ...
       y = df_mm_mx_last40[df_mm_mx_last40.index.month == i]['tmax']
       ...
       database= df_mm_mx_last40.loc[df_mm_mx_last40['month']==i][['tmax','year']]
...
for i in range(1,13):
       ax = fig.add_subplot(3,4,i)
       x = df_mm_mx_last40[df_mm_mx_last40.index.month == i].index.year
       y = df_mm_mx_last40[df_mm_mx_last40.index.month == i]['tmin']
       ...
       # Make the linear regression
       database= df_mm_mx_last40.loc[df_mm_mx_last40['month']==i][['tmin','year']]
       database=database.dropna()
...
for i in range(1,13):
       ax = fig.add_subplot(3,4,i)
       x = df_mm_mx_last40[df_mm_mx_last40.index.month == i].index.year
       y = df_mm_mx_last40[df_mm_mx_last40.index.month == i]['precip']
       ...
       # Make the linear regression
       database= df_mm_mx_last40.loc[df_mm_mx_last40['month']==i][['precip','year']]
       database=database.dropna()
